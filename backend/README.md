...
## Project Structure
    ...
    ├── testapiautostorybo_109138  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_109138`
...
2. Clone this repo and `cd testapiautostorybo_109138`
